package com.carndos.modules.res.controller;
...
public class ResController extends BaseController {
    ...
    public Map queryResTree() {
        List<ResBO> resTree = resourceService.queryResTree();
     ...
     */
    @PostMapping("create")
    public Map createResource(ResBO poJoResNode) {
     ...
     */
    @PostMapping("update")
    public Map updateResource(ResBO poJoResNode) {
